...
public abstract class lr_parser {
	...
	public void dump_stack(PrintStream xml) {
		...
		for (int i = 0; i < stack.size(); i++) {
			...
			if (stack.elementAt(i) instanceof AnalisisLexico.PascalSym) {
				((AnalisisLexico.PascalSym) (stack.elementAt(i))).toXML(xml);
			} else {
				if (i == 0) {
					...
					xml
							.println("<nonterminal value=\""
									+ AnalisisSintactico.Main.pascalNontNames[((Symbol) (stack
											.elementAt(i))).sym] + "\"/>");
				}
			}
			xml.println("</state>");
